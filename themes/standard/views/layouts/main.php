...
<html class="no-js" lang="en">
  <head>
    ...
    <script type="text/javascript">
        window.cookieconsent_options = {"message":"Utilizzando questo sito, acconsenti all'uso dei cookie, così come prescritto dalla vigente normativa","dismiss":"Accetto","learnMore":"Informativa","link":<?php echo Yii::app()->createUrl('site/pageload', array('id' => 9))?>,"theme":"dark-bottom"};
    </script>
