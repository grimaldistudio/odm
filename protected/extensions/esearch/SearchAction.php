...
class SearchAction extends CAction {
	...
	public $resultView = 'part/_searchresults';
	public $viewPath = 'webroot.themes.standard.views.site.';
	public $model;
	public $with = array();
	...
	public $urlAttribute;
	public $urlCallback;
	public $urlExpression = 'array(strtolower(substr(get_class($result),0,1)).substr(get_class($result),1)."/view", "id"=>$result->CODICE)';
